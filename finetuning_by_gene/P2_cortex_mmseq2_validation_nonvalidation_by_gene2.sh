...
mmseqs createdb P2_cortex_finetuning_by_gene_nonvalidation.fasta nontestDB
mmseqs createdb P2_cortex_finetuning_by_gene_validation.fasta testDB
...
seqkit grep -v -f unique_sequences_to_remove.txt P2_cortex_finetuning_by_gene_nonvalidation.fasta > P2_cortex_by_gene_filtered_nonvalidation.fasta
